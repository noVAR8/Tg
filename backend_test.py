...
class TelegramBotTester:
    ...
    async def run_all_tests(self):
        ...
        tests = [
            ...
            ("Enhanced Database Stats", self.test_stats_endpoint),
            ("Users API Endpoint", self.test_users_api_endpoint),
            ("Referrals API Endpoint", self.test_referrals_api_endpoint),
            ("User Profile Creation", self.test_user_profile_creation),
            ("Profile Command", self.test_profile_command),
            ("Referral Command", self.test_referral_command),
            ("Referral System", self.test_referral_system),
            ("Attempt System", self.test_attempt_system),
